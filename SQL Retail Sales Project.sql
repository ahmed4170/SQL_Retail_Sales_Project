...
-- Category identifing: Identify all unique product categories in the dataset.
...
-- Change the null Values in the age with the mean of the age column
...
-- Delete the null Values of the Total Sales Column
